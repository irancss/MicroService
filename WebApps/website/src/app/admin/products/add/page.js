...
import Seo from "@components/Admin/Product/Add/Seo";
import Notifications from "@components/Admin/Product/Add/Notifications";
...
const tabs = [
  { label: "Basic Information", component: Information },
  { label: "Media", component: Media },
...
const isEdit = typeof window !== "undefined" && new URLSearchParams(window.location.search).has("title");
