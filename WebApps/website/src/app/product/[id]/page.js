import Breadcrumb from "@/app/components/General/Breadcrumb";
import Images from "@/app/components/Product/Images";
import MainSectionProduct from "@/app/components/Product/Main";
import OfferTimer from "@/app/components/Product/OfferTimer";
import OurFeature from "@/app/components/Product/Our-Feature";
import Sellers from "@/app/components/Product/Sellers";
import SidebarProduct from "@/app/components/Product/Sidebar";
import SimilarProduct from "@/app/components/Product/Similar";
import VideoReview from "@/app/components/Product/Video-Review";
import Introduction from "@/app/components/Product/Introduction";
import { cookies } from "next/headers";
import Specifications from "@/app/components/Product/Specifications";
import Review from "@/app/components/Product/Review";
import Question from "@/app/components/Product/Question";
import BriefSidebar from "@/app/components/Product/Breif-Sidebar";
