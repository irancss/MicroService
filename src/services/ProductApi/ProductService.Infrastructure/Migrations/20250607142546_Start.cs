        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Weight = table.Column<decimal>(type: "numeric(18,3)", nullable: true),
                    DimensionLength = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    DimensionWidth = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    DimensionHeight = table.Column<decimal>(type: "numeric(18,2)", nullable: true),
                    Dimensions_Id = table.Column<string>(type: "text", nullable: true),
                    Dimensions_CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Dimensions_UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    Dimensions_IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    Dimensions_IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                    Dimensions_PublishedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MediaInfos_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                name: "ProductDescriptiveAttributes",
                columns: table => new
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    ProductId = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductDescriptiveAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductDescriptiveAttributes_ProductAttributes_ProductAttri~",
                        column: x => x.ProductAttributeId,
                        principalTable: "ProductAttributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProductDescriptiveAttributes_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Sku = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    PriceOverwrite = table.Column<decimal>(type: "numeric", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    AdminReply = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                    PublishedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FixedDiscountAmount = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ScheduledDiscounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ScheduledDiscounts_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ParentAttributeValueId = table.Column<string>(type: "text", nullable: false),
                    Value = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: false),
                    NameOrLabel = table.Column<string>(type: "text", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAttributeValues_ProductAttributeValues_ParentAttribu~",
                        column: x => x.ParentAttributeValueId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AltText = table.Column<string>(type: "character varying(255)", maxLength: 255, nullable: true),
                    IsPrimary = table.Column<bool>(type: "boolean", nullable: false),
                    IsPrimaryForVariant = table.Column<bool>(type: "boolean", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Currency = table.Column<string>(type: "text", nullable: false, defaultValue: "تومان"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastStockUpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    LocationInWarehouse = table.Column<string>(type: "text", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                    IsPublished = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductVariantStocks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductVariantStocks_ProductVariants_ProductVariantId",
                        column: x => x.ProductVariantId,
                        principalTable: "ProductVariants",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsAdminAnswer = table.Column<bool>(type: "boolean", nullable: false),
                    IsApproved = table.Column<bool>(type: "boolean", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MediaInfos_ProductId",
                table: "MediaInfos",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributeValues_ParentAttributeValueId",
                table: "ProductAttributeValues",
                column: "ParentAttributeValueId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductDescriptiveAttributes_ProductAttributeId",
                table: "ProductDescriptiveAttributes",
                column: "ProductAttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductDescriptiveAttributes_ProductId",
                table: "ProductDescriptiveAttributes",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductVariantStocks_ProductVariantId",
                table: "ProductVariantStocks",
                column: "ProductVariantId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ScheduledDiscounts_ProductId",
                table: "ScheduledDiscounts",
                column: "ProductId");
